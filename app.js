...
// Typed.js para efecto de escritura
    ...
    const animatedElements = document.querySelectorAll('.section h2, .project-item, .tech-icon, .sobre-mi-texto p, .social-icons a, .profile-pic');
    ...
    const elementObserver = new IntersectionObserver((entries, observer) => {
        entries.forEach((entry, index) => {
            if (entry.isIntersecting) {
                ...
                const delay = entry.target.classList.contains('project-item') || entry.target.classList.contains('tech-icon') ? index * 100 : 0;
    ...
    // --- NUEVA LÓGICA PARA ACORDEÓN DE PROYECTOS ---
    ...
    projectHeaders.forEach(header => {
        header.addEventListener('click', () => {
            ...
            // Opcional: Descomenta las siguientes líneas si quieres que solo uno esté abierto a la vez
